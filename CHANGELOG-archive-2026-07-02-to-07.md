# CHANGELOG archive (before 2026-07-08)

Historical entries moved from [CHANGELOG.md](CHANGELOG.md) on 2026-07-15. Newest entries remain in the main changelog.
...
- **R3 split into R3a–R3f** in [docs/archive/react-migration-plan.md](docs/archive/react-migration-plan.md) (each ~R2 intensity). Added **6 Vitest specs** (EventsView, EventHubView XSS guards, format utils). `npm test` green.
...
- Added [docs/archive/react-migration-plan.md](docs/archive/react-migration-plan.md) — decision + phased plan to adopt **React + TypeScript + Vite** (build step, CSP notes, phased R0–R4, docs/rules to update). No code migrated yet.
