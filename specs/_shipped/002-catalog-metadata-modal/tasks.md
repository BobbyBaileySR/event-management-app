...
**Input**: Design documents from `/specs/_shipped/002-catalog-metadata-modal/`
...
- [X] T001 Confirm 001-catalog-admin deployed and prerequisites in `specs/_shipped/002-catalog-metadata-modal/quickstart.md` §Prerequisites
...
- [X] T007 [P] Merge 002 metadata delta from `specs/_shipped/002-catalog-metadata-modal/contracts/catalog-api.md` into `Frontend/docs/api-contract.md`
...
- [X] T031 Run `Backend/npm test` and `npm run lint:fix` per `specs/_shipped/002-catalog-metadata-modal/quickstart.md` §1
- [X] T032 Run `Frontend/npm test` and `npm run lint` per `specs/_shipped/002-catalog-metadata-modal/quickstart.md` §2
...
- [X] T035 Execute manual QA in `specs/_shipped/002-catalog-metadata-modal/quickstart.md` §3–§12 (**§11 responsive is a release gate** before deploy) and update Manual QA log table
