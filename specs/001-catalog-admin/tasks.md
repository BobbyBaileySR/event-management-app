...
- [x] T042 Execute manual scenarios in `specs/001-catalog-admin/quickstart.md` — **partial (2026-07-03)**: §1–§3, §7 **pass**; §5 partial (BUG-1–3); §4/§6/§8/§9/§10 not complete — see `quickstart.md` QA log + `bugs.md`
...
- [x] T054 Re-run quickstart §4 (viewer), §5–§6, §8; then §9–§10 per `specs/001-catalog-admin/quickstart.md` — **pass (2026-07-04)**
