...
- **Frontend → Backend**: All live data and session auth flow through the ScriptRunner Generic HTTP listener (`API_BASE_URL` + `X-EMS-Route` header). See [docs/api-contract.md](./docs/api-contract.md).
