...
export interface EmsConfig {
	...
	/** Client-side default matching Backend's `LEAD_BATCH_CONFIRM_THRESHOLD` fallback (014-lead-generation, research.md R-002) — a separate value from email dispatch's threshold. */
	LEAD_BATCH_CONFIRM_THRESHOLD: number;
}
...
export const CONFIG: EmsConfig = {
	...
	LEAD_BATCH_CONFIRM_THRESHOLD: 50,
};
